...
const performanceEventSchema = z.object({
  ...
  scannedRows: z.number().int().min(0).max(100_000).optional(),
  fragRows: z.number().int().min(0).max(100_000).optional(),
  fragTruecolor: z.number().int().min(0).max(100_000).optional(),
  frag256: z.number().int().min(0).max(100_000).optional(),
  fragCup: z.number().int().min(0).max(100_000).optional(),
  fragPartial: z.number().int().min(0).max(100_000).optional(),
  fragEsc: z.number().int().min(0).max(100_000).optional(),
  wideRows: z.number().int().min(0).max(100_000).optional(),
  ambiguousRows: z.number().int().min(0).max(100_000).optional(),
  ambiguousCells: z.number().int().min(0).max(1_000_000).optional(),
  overflowPx: z.number().int().min(0).max(100_000).optional(),
  viewportY: z.number().int().min(0).max(10_000_000).optional(),
